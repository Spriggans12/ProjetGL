...
//
//
// Constructor for XML Schema item {http://webservice/}helloResponse
//
function webservice__helloResponse () {
    this.typeMarker = 'webservice__helloResponse';
    this._return = null;
}

//
// accessor is webservice__helloResponse.prototype.getReturn
// element get for return
// - element type is {http://www.w3.org/2001/XMLSchema}string
// - optional element
//
// element set for return
// setter function is is webservice__helloResponse.prototype.setReturn
//
function webservice__helloResponse_getReturn() { return this._return;}

webservice__helloResponse.prototype.getReturn = webservice__helloResponse_getReturn;

function webservice__helloResponse_setReturn(value) { this._return = value;}

webservice__helloResponse.prototype.setReturn = webservice__helloResponse_setReturn;
//
// Serialize {http://webservice/}helloResponse
//
function webservice__helloResponse_serialize(cxfjsutils, elementName, extraNamespaces) {
    var xml = '';
    if (elementName != null) {
     xml = xml + '<';
     xml = xml + elementName;
...
webservice__helloResponse.prototype.serialize = webservice__helloResponse_serialize;

function webservice__helloResponse_deserialize (cxfjsutils, element) {
    var newobject = new webservice__helloResponse();
...
//
// Constructor for XML Schema item {http://webservice/}hello
//
function webservice__hello () {
    this.typeMarker = 'webservice__hello';
}

//
// Serialize {http://webservice/}hello
//
function webservice__hello_serialize(cxfjsutils, elementName, extraNamespaces) {
    var xml = '';
    if (elementName != null) {
     xml = xml + '<';
     xml = xml + elementName;
...
webservice__hello.prototype.serialize = webservice__hello_serialize;

function webservice__hello_deserialize (cxfjsutils, element) {
    var newobject = new webservice__hello();
    cxfjsutils.trace('element: ' + cxfjsutils.traceElementName(element));
    var curElement = cxfjsutils.getFirstElementChild(element);
    var item;
    return newobject;
...
function webservice__Area () {
    ...
    this.globalElementSerializers['{http://webservice/}helloResponse'] = webservice__helloResponse_serialize;
    this.globalElementDeserializers['{http://webservice/}helloResponse'] = webservice__helloResponse_deserialize;
    ...
    this.globalElementSerializers['{http://webservice/}hello'] = webservice__hello_serialize;
    this.globalElementDeserializers['{http://webservice/}hello'] = webservice__hello_deserialize;
...
function webservice__hello_op_onsuccess(client, responseXml) {
    if (client.user_onsuccess) {
     ...
     this.jsutils.trace('calling webservice__helloResponse_deserializeResponse');
     responseObject = webservice__helloResponse_deserializeResponse(this.jsutils, element);
     client.user_onsuccess(responseObject);
    }
}

webservice__Area.prototype.hello_onsuccess = webservice__hello_op_onsuccess;

function webservice__hello_op_onerror(client) {
...
webservice__Area.prototype.hello_onerror = webservice__hello_op_onerror;

//
// Operation {http://webservice/}hello
// Wrapped operation.
//
function webservice__hello_op(successCallback, errorCallback) {
...
webservice__Area.prototype.hello = webservice__hello_op;

function webservice__hello_serializeInput(cxfjsutils, args) {
    var wrapperObj = new webservice__hello();
    var xml;
...
webservice__Area.prototype.hello_serializeInput = webservice__hello_serializeInput;

function webservice__helloResponse_deserializeResponse(cxfjsutils, partElement) {
    var returnObject = webservice__helloResponse_deserialize (cxfjsutils, partElement);
